...
export const MinecraftProjectCard = ({ project, supportersCount = 0 }: MinecraftProjectCardProps) => {
  ...
  return (
    <div
      ...
      className="group cursor-pointer transform transition-all duration-200 hover:scale-105 hover:translate-y-[-4px]"
    >
      {/* Minecraft-style pixelated card */}
      <div className="relative bg-gradient-to-b from-[#8B4513] to-[#654321] p-1">
        ...
        {/* Card content */}
        <div className="relative bg-gradient-to-b from-[#D2B48C] via-[#C4A07A] to-[#B8956A] p-6 border-4 border-[#654321]">
          {/* Status badge */}
          ...
          {/* Project Title */}
          <h3 className="text-xl font-bold text-[#2D1B00] mb-2 truncate group-hover:text-[#FF6B35] transition-colors">
            Project #{project.id.slice(0, 8)}...
          </h3>

          {/* Creator Address */}
          <p className="text-sm text-[#5D4E37] mb-4 font-mono truncate">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            {/* Total Raised */}
            <div className="bg-[#8B7355] border-2 border-[#654321] p-3 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.2)]">
            ...
            <div className="bg-[#8B7355] border-2 border-[#654321] p-3 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.2)]">
              <div className="flex items-center gap-2 mb-1">
                <Users className="w-4 h-4 text-[#55AAFF]" />
                <span className="text-xs font-bold text-[#55AAFF]">BACKERS</span>
              </div>
              <p className="text-lg font-bold text-white">{supportersCount}</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="h-6 bg-[#654321] border-2 border-[#3D2817] overflow-hidden">
              <div
