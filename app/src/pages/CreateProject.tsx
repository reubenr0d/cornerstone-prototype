...
interface Milestone {
  ...
  title: string;
  summary: string;
  payout: string; // percent of max rai
  dueDate: string;
}
...
{currentStep === 2 && (
  <div className="space-y-6">
    ...
    <div className="space-y-4">
      <h3 className="font-semibold">Phase Withdrawal Caps</h3>
          ...
          <CardContent>
            <div>
              ...
              <Input 
                ...
                disabled={index === milestones.length - 2} // Last phase
                onChange={(e) => {
                  const v = e.target.value;
                  setMilestones(prev => prev.map((m, i) => 
                    i === index + 1 ? { ...m, payout: v } : m
                  ));
                }}
              />
            </div>
