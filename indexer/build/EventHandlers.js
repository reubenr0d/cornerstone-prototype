...
exports.handlePhaseConfiguration = exports.handleRevenueClaimed = exports.handlePrincipalClaimed = exports.handleSalesProceedsSubmitted = exports.handleAppraisalSubmitted = exports.handlePhaseFundsWithdrawn = exports.handlePhaseClosed = exports.handleFundraiseClosed = exports.handleReserveFunded = exports.handleInterestClaimed = exports.handleDeposit = exports.handleProjectCreated = void 0;
const generated_1 = require("generated");
// Register new CornerstoneProject contracts dynamically
generated_1.ProjectRegistry.ProjectCreated.contractRegister(({ event, context }) => {
    context.addCornerstoneProject(event.params.project);
});
exports.handleProjectCreated = generated_1.ProjectRegistry.ProjectCreated.handler(async ({ event, context }) => {
...
exports.handleDeposit = generated_1.CornerstoneProject.Deposit.handler(async ({ event, context }) => {
...
exports.handleInterestClaimed = generated_1.CornerstoneProject.InterestClaimed.handler(async ({ event, context }) => {
...
exports.handleReserveFunded = generated_1.CornerstoneProject.ReserveFunded.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
exports.handleFundraiseClosed = generated_1.CornerstoneProject.FundraiseClosed.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
exports.handlePhaseClosed = generated_1.CornerstoneProject.PhaseClosed.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
exports.handlePhaseFundsWithdrawn = generated_1.CornerstoneProject.PhaseFundsWithdrawn.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
    const phaseId = Number(event.params.phaseId);
...
exports.handleAppraisalSubmitted = generated_1.CornerstoneProject.AppraisalSubmitted.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
exports.handleSalesProceedsSubmitted = generated_1.CornerstoneProject.SalesProceedsSubmitted.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
exports.handlePrincipalClaimed = generated_1.CornerstoneProject.PrincipalClaimed.handler(async ({ event, context }) => {
    const claimerId = event.params.user.toLowerCase();
    const projectAddress = event.srcAddress.toLowerCase();
    let depositor = await context.Depositor.get(claimerId);
    if (depositor) {
...
exports.handleRevenueClaimed = generated_1.CornerstoneProject.RevenueClaimed.handler(async ({ event, context }) => {
    const claimerId = event.params.user.toLowerCase();
    const projectAddress = event.srcAddress.toLowerCase();
    let depositor = await context.Depositor.get(claimerId);
    if (depositor) {
...
exports.handlePhaseConfiguration = generated_1.CornerstoneProject.PhaseConfiguration.handler(async ({ event, context }) => {
    const projectAddress = event.srcAddress.toLowerCase();
    const txHash = event.block.hash;
...
async function updateDepositorMetrics(userId, projectAddress, event, context) {
